  ...
  wa = (e, t, r, n) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let i of ga(t))
        !ya.call(e, i) &&
          i !== r &&
          on(e, i, { get: () => t[i], enumerable: !(n = fa(t, i)) || n.enumerable });
    return e;
  };
var Ue = (e, t, r) => (
  (r = e != null ? da(ha(e)) : {}),
...
function Ha(e) {
  let t = {
    ...
    r = (...n) => {
      ...
      if (
        (n.length !== 0 && pr.push([o, ...n]), pr.length > Wa && pr.shift(), vt.enabled(o) || i)
      ) {
...
R.logarithm = R.log = function (e) {
  ...
  if (
    ...
    do
      if (
        ((a += 10), (s = Oe(f, a)), (n = t ? xr(g, a + 10) : Oe(e, a)), (l = $(s, n, a, 1)), !o)
      ) {
...
function Nu(e) {
  ...
  for (let n of e) {
    ...
    o
      ? t.set(i, {
          ...n,
          argument: { ...n.argument, typeNames: Fu(o.argument.typeNames, n.argument.typeNames) },
        })
      : t.set(i, n);
  }
...
var ls = (e) => (Array.isArray(e) ? e : e.split('.')),
  ...
  us = (e, t, r) =>
    ls(t).reduceRight((n, i, o, s) => Object.assign({}, $n(e, s.slice(0, o)), { [i]: n }), r);
function Dc(e, t) {
