...
console.log(
  `WCAG 2.1 AA compliant: ${testCombinations.filter(({ fg, bg }) => meetsWCAG(fg, bg, 'AA')).length}`,
);
console.log(
  `WCAG 2.1 AAA compliant: ${testCombinations.filter(({ fg, bg }) => meetsWCAG(fg, bg, 'AAA')).length}`,
);
