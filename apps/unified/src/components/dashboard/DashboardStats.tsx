...
export function DashboardStats() {
      ...
      case 'admin':
        ...
        return [
          ...
          },
          {
            ...
            change:
              parseFloat(performance?.errorRate || '0') < 1 ? 'Performing well' : 'Needs attention',
            icon: ClockIcon,
            color: 'text-yellow-600',
            changeColor:
              parseFloat(performance?.errorRate || '0') < 1 ? 'text-green-600' : 'text-red-600',
          },
          {
            name: 'System Health',
            ...
            changeColor:
              parseFloat(performance?.avgResponseTime || '0') < 200
                ? 'text-green-600'
                : 'text-yellow-600',
          },
        ];
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat) => (
          <div key={stat.name} className="card p-6 transition-shadow duration-200 hover:shadow-lg">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <div className="flex items-baseline">
                  ...
                  {stat.change && (
                    <p
                      className={`ml-2 text-sm font-medium ${stat.changeColor || 'text-green-600'}`}
                    >
                      {stat.change}
                    </p>
                  )}
