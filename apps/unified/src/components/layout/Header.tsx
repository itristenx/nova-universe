...
export function Header({ onMenuClick, onToggleSidebar, sidebarCollapsed }: HeaderProps) {
  ...
  return (
    <>
      <header className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4 lg:px-6 dark:border-gray-700 dark:bg-gray-800">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="hidden rounded-lg p-2 text-gray-600 hover:bg-gray-100 lg:block dark:text-gray-400 dark:hover:bg-gray-700"
          >
            {sidebarCollapsed ? (
          ...
          <Link to="/dashboard" className="flex items-center gap-2">
            ...
            <span className="hidden text-lg font-semibold text-gray-900 sm:block dark:text-gray-100">
              {t('app.name')}
            </span>
          </Link>
        ...
        <div className="mx-4 max-w-xl flex-1">
          ...
          >
            ...
            <div className="ml-auto flex items-center gap-1">
              <kbd className="hidden rounded border border-gray-300 px-1.5 py-0.5 text-xs text-gray-600 sm:inline dark:border-gray-600 dark:text-gray-400">
                ⌘
              </kbd>
              <kbd className="hidden rounded border border-gray-300 px-1.5 py-0.5 text-xs text-gray-600 sm:inline dark:border-gray-600 dark:text-gray-400">
                K
      ...
      <UnifiedCommandCenter isOpen={searchOpen} onClose={() => setSearchOpen(false)} />
    </>
  );
}
