...
const getAllNavigation = (t: any): NavigationItem[] => [
  ...
  // Core ITSM Functionality
  {
    ...
    children: [
      ...
      {
        name: t('sidebar.queueManagement'),
        href: '/tickets/queues',
        icon: TicketIcon,
        roles: ['admin', 'agent'],
      },
      {
        name: t('sidebar.slaManagement'),
        href: '/tickets/sla',
        icon: TicketIcon,
        roles: ['admin'],
      },
  ...
  // Asset Management (Nova Core)
  {
    ...
    children: [
      ...
      {
        name: t('sidebar.assetCheckInOut'),
      ...
      {
        name: t('sidebar.assetCategories'),
        href: '/assets/categories',
        icon: CubeIcon,
        roles: ['admin'],
      },
      {
        name: t('sidebar.maintenanceTracking'),
  ...
  // Space Management (Nova Atlas)
  {
    ...
    children: [
      ...
      {
        name: t('sidebar.allSpaces'),
        href: '/spaces',
        icon: BuildingOfficeIcon,
        roles: ['admin', 'agent'],
      },
      {
        name: t('sidebar.spaceAnalytics'),
        href: '/spaces/analytics',
        icon: ChartBarIcon,
        roles: ['admin'],
      },
      {
        name: t('sidebar.floorPlans'),
        href: '/spaces/floorplans',
        icon: MapIcon,
        roles: ['admin'],
      },
    ],
  ...
  // Digital Signage (Nova TV)
  {
    ...
    children: [
      ...
      {
        name: t('sidebar.deviceManagement'),
        href: '/nova-tv/devices',
        icon: TvIcon,
        roles: ['admin', 'agent'],
      },
      {
        name: t('sidebar.dashboardBuilder'),
        href: '/nova-tv/builder',
        icon: WrenchScrewdriverIcon,
        roles: ['admin', 'agent'],
      },
      {
        name: t('sidebar.qrAuthentication'),
        href: '/nova-tv/auth',
  ...
  // Knowledge Management
  {
    ...
    children: [
      ...
      {
        name: t('sidebar.createArticle'),
        href: '/knowledge/create',
        icon: DocumentTextIcon,
        roles: ['admin', 'agent'],
      },
      {
        name: t('sidebar.manageCategories'),
  ...
  // Communication & Collaboration
  {
    ...
    children: [
      ...
      {
        name: t('sidebar.teamChat'),
        href: '/communications/chat',
        icon: ChatBubbleLeftIcon,
        roles: ['admin', 'agent'],
      },
      {
        name: t('sidebar.broadcastMessages'),
  ...
  // Monitoring & Operations (Nova Sentinel)
  {
    ...
    children: [
      ...
      {
        name: t('sidebar.serviceStatus'),
        href: '/monitoring/status',
        icon: CloudIcon,
        roles: ['admin', 'agent'],
      },
      {
        name: t('sidebar.performanceMetrics'),
  ...
  // AI Integration & Automation (Cosmo)
  {
    ...
    children: [
      ...
      {
        name: t('sidebar.automationHub'),
        href: '/automation',
        icon: WrenchScrewdriverIcon,
        roles: ['admin', 'agent'],
      },
      {
        name: t('sidebar.mailroomIntegration'),
        href: '/automation/mailroom',
        icon: EnvelopeIcon,
        roles: ['admin', 'agent'],
      },
      { name: t('sidebar.mobileCompanion'), href: '/mobile/companion', icon: CpuChipIcon },
      {
        name: t('sidebar.accessibilityAudit'),
      ...
      {
        name: t('sidebar.modelConfiguration'),
        href: '/ai/config',
        icon: Cog6ToothIcon,
        roles: ['admin'],
      },
  ...
  // Administration (Nova Core)
  {
    ...
    children: [
      ...
      {
        name: t('sidebar.rolePermissions'),
        href: '/admin/roles',
        icon: ShieldCheckIcon,
        roles: ['admin'],
      },
      ...
      {
        name: t('sidebar.systemConfiguration'),
        href: '/admin/system',
        icon: Cog6ToothIcon,
        roles: ['admin'],
      },
      {
        name: t('sidebar.emailAccounts'),
      ...
      {
        name: t('sidebar.siteAssetManagement'),
        href: '/admin/assets',
        icon: CubeIcon,
        roles: ['admin'],
      },
      {
        name: t('sidebar.integrationManagement'),
  ...
  // Analytics & Reporting
  {
    ...
    children: [
      {
        name: t('sidebar.performanceDashboard'),
        href: '/analytics/performance',
        icon: ChartBarIcon,
        roles: ['admin', 'agent'],
      },
      {
        name: t('sidebar.serviceReports'),
        href: '/analytics/service',
        icon: ChartBarIcon,
        roles: ['admin', 'agent'],
      },
      {
        name: t('sidebar.assetReports'),
        href: '/analytics/assets',
        icon: ChartBarIcon,
        roles: ['admin'],
      },
      {
        name: t('sidebar.spaceUtilization'),
        href: '/analytics/spaces',
        icon: ChartBarIcon,
        roles: ['admin'],
      },
      {
        name: t('sidebar.customReports'),
...
export function Sidebar({ isOpen, isCollapsed, onClose }: SidebarProps) {
      ...
      return (
        <li key={item.name}>
          <button
            ...
            className={cn('nav-link w-full justify-between', sectionActive && 'nav-link-active')}
          >
          ...
          {isExpanded && (
            <ul className="mt-2 ml-4 space-y-1 border-l-2 border-gray-200 pl-4 dark:border-gray-700">
  ...
  const sidebarContent = (
    <>
      ...
      <nav className="mt-8 px-4">
        <ul className="space-y-2">{navigation.map((item) => renderNavigationItem(item))}</ul>
      </nav>
    </>
  );
  ...
  return (
    <>
      ...
      <div
        className={cn(
          'fixed inset-y-0 left-0 z-30 w-64 transform bg-white shadow-lg transition-transform duration-300 ease-in-out lg:hidden dark:bg-gray-800',
      ...
      <div
        className={cn(
          'fixed inset-y-0 left-0 z-20 hidden bg-white shadow-lg transition-all duration-300 lg:block dark:bg-gray-800',
