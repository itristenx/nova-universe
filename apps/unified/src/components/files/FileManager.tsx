  ...
  if (error) {
    return (
      <div className="rounded-md bg-red-50 p-4 dark:bg-red-900/20">
        <div className="text-sm text-red-700 dark:text-red-400">Error loading files: {error}</div>
      </div>
    );
  }
        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            ...
            <input
              ...
              className="focus:border-nova-500 focus:ring-nova-500 w-64 rounded-md border border-gray-300 bg-white py-2 pr-4 pl-10 text-sm placeholder-gray-500 focus:ring-1 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:placeholder-gray-400"
            />
          </div>
          ...
          <select
            ...
            className="focus:border-nova-500 focus:ring-nova-500 rounded-md border border-gray-300 bg-white px-3 py-2 text-sm focus:ring-1 focus:outline-none dark:border-gray-600 dark:bg-gray-800 dark:text-white"
        ...
        <div className="flex items-center space-x-2">
          {selectedFiles.size > 0 && (
            <button
              ...
              className="inline-flex items-center space-x-1 rounded-md bg-red-600 px-3 py-2 text-sm text-white hover:bg-red-700 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:outline-none"
            >
          ...
          {filteredFiles.map((file) => (
            <div
              ...
              className={cn(
                ...
                selectable && selectedFiles.has(file.id) && 'ring-nova-500 ring-2',
            ...
            >
              ...
              <div className="flex flex-col items-center space-y-3">
                ...
                <div className="w-full text-center">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">{file.storageProvider}</p>
                </div>
