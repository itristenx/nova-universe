...
const TruckIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M8.25 18.75a1.5 1.5 0 01-3 0 1.5 1.5 0 013 0zM19.5 18.75a1.5 1.5 0 01-3 0 1.5 1.5 0 013 0zM3 4.5h11.25a1.5 1.5 0 011.5 1.5v7.5a1.5 1.5 0 01-1.5 1.5H3m0-10.5V9a1.5 1.5 0 001.5 1.5h11.25V4.5H3z"
    />
  </svg>
);
...
const PackageList: React.FC<PackageListProps> = ({ packages, loading, onPackageUpdate }) => {
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center space-x-3">
                  <p className="truncate text-sm font-medium text-gray-900">{pkg.trackingNumber}</p>
                  <span
                    className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${getStatusColor(pkg.status)}`}
                  >
