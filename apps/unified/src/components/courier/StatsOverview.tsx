...
const StatsOverview: React.FC = () => {
  ...
  return (
    <div>
      <h3 className="mb-4 text-lg leading-6 font-medium text-gray-900">Package Statistics</h3>
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {statItems.map((item) => (
      ...
      <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2">
        ...
        <div className="rounded-lg bg-white p-6 shadow">
          <h4 className="mb-4 text-base font-medium text-gray-900">Top Carriers</h4>
            ...
            {stats.topCarriers.slice(0, 5).map((carrier) => (
              <div key={carrier.carrier} className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs text-gray-500">({carrier.percentage.toFixed(1)}%)</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="rounded-lg bg-white p-6 shadow">
          <h4 className="mb-4 text-base font-medium text-gray-900">Department Breakdown</h4>
          <div className="space-y-3">
            {stats.departmentBreakdown.slice(0, 5).map((dept) => (
              <div key={dept.department} className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs text-gray-500">({dept.percentage.toFixed(1)}%)</span>
                </div>
              </div>
            ))}
          </div>
