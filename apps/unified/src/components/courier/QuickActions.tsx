      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {actions.map((action) => (
          <button
            ...
            className="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-violet-500 rounded-lg shadow hover:shadow-md transition-shadow duration-200"
          >
            <div>
