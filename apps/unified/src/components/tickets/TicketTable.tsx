...
export function TicketTable({ 
  ...
  const handleSelectAll = () => {
    if (allSelected) {
      // Deselect all
      setSelectedTickets(selectedTickets.filter(id => !tickets.some(ticket => ticket.id === id)))
    } else {
    ...
    return (
      <ChevronUpDownIcon 
        className={cn(
          ...
          currentSort ? 'text-nova-600' : 'text-gray-400'
        )} 
      />
    )
  }
              ...
              <div>
                <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm">
                  ...
                  <button
                    onClick={() => handlePageChange(pagination.page - 1)}
                    disabled={!pagination.hasPrev}
                    className="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 disabled:cursor-not-allowed disabled:opacity-50 dark:ring-gray-700 dark:hover:bg-gray-800"
                  >
                  ...
                  {pageNumbers.map((page, index) => (
                    page === -1 ? (
                      <span
                        key={`ellipsis-${index}`}
                        className="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-700 ring-1 ring-inset ring-gray-300 dark:ring-gray-700 dark:text-gray-300"
                      >
                        ...
                      </span>
                    ) : (
                      <button
                        ...
                        className={cn(
                          'relative inline-flex items-center px-4 py-2 text-sm font-semibold ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 dark:ring-gray-700 dark:hover:bg-gray-800',
                          page === pagination.page
                            ? 'z-10 bg-nova-600 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-nova-600'
                  ...
                  <button
                    onClick={() => handlePageChange(pagination.page + 1)}
                    disabled={!pagination.hasNext}
                    className="relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 disabled:cursor-not-allowed disabled:opacity-50 dark:ring-gray-700 dark:hover:bg-gray-800"
                  >
