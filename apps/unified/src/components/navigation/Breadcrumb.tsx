...
const getRouteBreadcrumbs = (t: (key: string) => string): Record<string, BreadcrumbItem[]> => ({
  '/dashboard': [{ label: t('navigation.dashboard'), current: true }],
  '/tickets': [{ label: t('navigation.tickets'), current: true }],
  '/tickets/new': [
    { label: t('navigation.tickets'), href: '/tickets' },
    { label: t('navigation.createTicket'), current: true },
  ],
  '/assets': [{ label: t('navigation.assets'), current: true }],
  '/assets/new': [
    { label: t('navigation.assets'), href: '/assets' },
    { label: t('navigation.createAsset'), current: true },
  ],
  '/spaces': [{ label: t('navigation.spaces'), current: true }],
  '/spaces/floor-plan': [
  ...
  '/profile': [{ label: t('navigation.profile'), current: true }],
  '/settings': [{ label: t('navigation.settings'), current: true }],
});
...
export function Breadcrumb({ items, separator }: BreadcrumbProps) {
  ...
  const breadcrumbItems =
    items || routeBreadcrumbs[location.pathname] || generateBreadcrumbsFromPath(location.pathname);
