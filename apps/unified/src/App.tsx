...
const UnifiedMonitoringDashboard = lazy(
  () => import('@pages/monitoring/UnifiedMonitoringDashboard'),
);
...
// Analytics pages
const EnhancedPerformanceAnalytics = lazy(
  () => import('@pages/analytics/EnhancedPerformanceAnalytics'),
);

// Gamification pages
const EnhancedGamificationSystem = lazy(
  () => import('@pages/gamification/EnhancedGamificationSystem'),
);
                  ...
                  <Suspense fallback={<LoadingSpinner />}>
                    <Routes>
                      ...
                      <Route
                        ...
                        element={<EnhancedPerformanceAnalytics />}
                      />
                      ...
                      <Route
                        ...
                        element={<IntelligentClassificationPage />}
                      />
