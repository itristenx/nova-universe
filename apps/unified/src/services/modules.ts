...
export class ModuleService {
   ...
   */
  static async updateConfiguration(key: string, configurations: Record<string, any>): Promise<Module> {
    const response = await apiClient.put<Module>(`${this.baseUrl}/${key}/config`, { configurations })
    if (!response.data) {
