...
import { assetService, type AssetFilters, type CreateAssetData, type UpdateAssetData, type BulkAssetAction } from '@services/assets'
import type { Asset, AssetCategory, AssetType, AssetLocation, MaintenanceRecord, PaginatedResponse, SortOption } from '@/types'
...
interface AssetState {
  ...
  checkoutAsset: (assetId: string, userId: string, dueDate?: string, notes?: string) => Promise<void>
