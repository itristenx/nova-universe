...
export default function AccessibilityAuditPage() {
  ...
  const wcagGuidelines = [
    {
      ...
      guidelines: [
        { id: '1.1', title: 'Text Alternatives', description: 'Provide text alternatives for non-text content' },
        { id: '1.2', title: 'Time-based Media', description: 'Provide alternatives for time-based media' },
        { id: '1.3', title: 'Adaptable', description: 'Create content that can be presented in different ways without losing meaning' },
        { id: '1.4', title: 'Distinguishable', description: 'Make it easier for users to see and hear content' }
      ]
    },
    {
      principle: 'Operable',
      guidelines: [
        { id: '2.1', title: 'Keyboard Accessible', description: 'Make all functionality available from a keyboard' },
        { id: '2.2', title: 'Enough Time', description: 'Provide users enough time to read and use content' },
        { id: '2.3', title: 'Seizures and Physical Reactions', description: 'Do not design content that causes seizures' },
        { id: '2.4', title: 'Navigable', description: 'Provide ways to help users navigate and find content' },
        { id: '2.5', title: 'Input Modalities', description: 'Make it easier for users to operate functionality through various inputs' }
      ]
    },
    {
      principle: 'Understandable',
      guidelines: [
        { id: '3.1', title: 'Readable', description: 'Make text content readable and understandable' },
        { id: '3.2', title: 'Predictable', description: 'Make web pages appear and operate in predictable ways' },
        { id: '3.3', title: 'Input Assistance', description: 'Help users avoid and correct mistakes' }
      ]
    },
    {
      principle: 'Robust',
      guidelines: [
        { id: '4.1', title: 'Compatible', description: 'Maximize compatibility with assistive technologies' }
      ]
    }
  ]
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-green-600 to-teal-600 rounded-xl px-6 py-8 text-white">
            ...
            {auditResults.length > 0 && (
              <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
                  ...
                  <div className="text-sm text-green-600 dark:text-green-400">{t('accessibility:passed')}</div>
                </div>
                <div className="bg-red-50 dark:bg-red-900/20 rounded-lg p-4">
                  <div className="text-2xl font-bold text-red-600 dark:text-red-400">{failCount}</div>
                  <div className="text-sm text-red-600 dark:text-red-400">{t('accessibility:failed')}</div>
                </div>
                <div className="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-4">
                  <div className="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{warningCount}</div>
                  <div className="text-sm text-yellow-600 dark:text-yellow-400">{t('accessibility:warnings')}</div>
                </div>
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                  <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">
                    {Math.round((passCount / auditResults.length) * 100)}%
                  </div>
                  <div className="text-sm text-blue-600 dark:text-blue-400">{t('accessibility:compliance')}</div>
                </div>
              </div>
            )}
          </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center space-x-3 mb-1">
                            ...
                            <span className={`px-2 py-1 rounded-full text-xs ${getImpactColor(result.impact)}`}>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-500">{t('accessibility:keyboardNavigationDesc')}</p>
                  </div>
                  <button
