...
const sampleArticles = [
  {
    ...
    excerpt:
      'Learn the step-by-step process for creating effective support tickets that get resolved quickly.',
  ...
  },
  {
    ...
    excerpt:
      'Discover professional strategies for tracking, maintaining, and optimizing your IT asset inventory.',
  ...
  },
  {
    ...
    excerpt:
      'Get familiar with pull-to-refresh, camera integration, and touch gestures in the mobile interface.',
...
export default function MobileFeaturesDemo() {
  ...
  const [activeTab, setActiveTab] = useState<'pull-refresh' | 'camera' | 'gestures' | 'knowledge'>(
    'pull-refresh',
  );
        ...
        {activeTab === 'gestures' && (
          <div className="space-y-4 p-4">
            ...
            <TouchGestureDetector
              ...
              className="rounded-lg border-2 border-dashed border-blue-300 bg-blue-50 p-8 text-center dark:border-blue-600 dark:bg-blue-900/20"
            >
              <svg
              ...
              <p className="text-gray-600 dark:text-gray-300">Try different gestures here</p>
            </TouchGestureDetector>
            ...
            {gestureLog.length > 0 && (
              <MobileCard>
                <h4 className="mb-3 font-medium text-gray-900 dark:text-white">Gesture Log</h4>
                <div className="max-h-40 space-y-1 overflow-y-auto">
                  {gestureLog.map((log, index) => (
                    <div key={index} className="font-mono text-xs text-gray-600 dark:text-gray-300">
                      {log}
                    </div>
                  ))}
                </div>
