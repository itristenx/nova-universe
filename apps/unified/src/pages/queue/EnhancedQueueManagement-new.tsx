...
export default function EnhancedQueueManagement({
  ...
  const queues: Queue[] =
    queueMetrics?.map((metric) => ({
      ...
      priority:
        metric.tickets_in_queue > 20 ? 'high' : metric.tickets_in_queue > 10 ? 'normal' : 'low',
      ...
      <div className="rounded-lg bg-white p-4 shadow">
        <div className="mb-4 flex items-center justify-between">
          ...
          <button
            ...
            className={cn('rounded p-1', autoRefresh ? 'text-blue-600' : 'text-gray-400')}
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
        <div>
          ...
          <p className="text-gray-600">Monitor and manage support queues</p>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className={cn(
              ...
              autoRefresh ? 'border-blue-300 bg-blue-50' : 'border-gray-300',
            )}
            aria-label={autoRefresh ? 'Disable auto-refresh' : 'Enable auto-refresh'}
          >
            <ArrowPathIcon className="h-4 w-4" />
      ...
      {queuesLoading ? (
        <div className="rounded-lg bg-white p-12 text-center shadow">
          ...
          <p className="mt-4 text-gray-500">Loading queue metrics...</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                {sortedQueues.map((queue) => (
                  <div
                    ...
                    className={cn(
                      ...
                      selectedQueue === queue.id && 'border-r-2 border-blue-500 bg-blue-50',
                    )}
                  >
                    <div className="flex items-start justify-between">
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-1 truncate text-xs text-gray-500">{queue.description}</p>
          ...
          <div className="lg:col-span-2">
            {selectedQueue ? (
                  ...
                  <div className="divide-y divide-gray-200">
                        ...
                        <div className="flex items-start justify-between">
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="mt-2 flex items-center space-x-4 text-xs text-gray-500">
                              <span>
                                Requested by: {ticket.requester.firstName}{' '}
                    ...
                    {queueTickets?.length === 0 && (
                      <div className="py-8 text-center">
                        <QueueListIcon className="mx-auto mb-2 h-12 w-12 text-gray-400" />
              ...
              <div className="rounded-lg bg-white p-12 text-center shadow">
                <QueueListIcon className="mx-auto mb-4 h-12 w-12 text-gray-400" />
                <h3 className="mb-2 text-lg font-medium text-gray-900">Select a Queue</h3>
