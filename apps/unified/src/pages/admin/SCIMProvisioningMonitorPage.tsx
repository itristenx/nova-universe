...
export default function SCIMProvisioningMonitorPage() {
  const [activeTab, setActiveTab] = useState<'overview' | 'users' | 'groups' | 'events' | 'config'>('overview')
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="font-medium text-gray-900 dark:text-gray-100">
              SCIM Status: {scimConfig.enabled ? 
                syncStatus === 'success' ? 'Active' :
                syncStatus === 'error' ? 'Error' : 'Running'
                : 'Disabled'}
            </h3>
                ...
                <div className="card p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 dark:text-gray-400">Last Sync Duration</div>
                    </div>
                  </div>
                </div>
              </div>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex flex-wrap gap-1">
                            {user.groups.map((group) => (
                              <span key={group} className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-300">
                                {group}
                              </span>
                            ))}
                          </div>
            ...
            <div className="space-y-4">
              <div className="space-y-3">
                {events.map((event) => {
                  ...
                  return (
                    <div key={event.id} className="flex items-start space-x-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                      <div className={cn(
                        "p-2 rounded-lg",
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                          {formatRelativeTime(event.timestamp)} • {event.eventType} • {event.resourceType}
                        </p>
                      </div>
                    </div>
                  )
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-700 dark:text-amber-400 mt-1">
                      SCIM configuration is managed through environment variables and cannot be modified through this interface.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        disabled
                        title="SCIM Endpoint"
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-gray-700 dark:text-gray-300">User Sync Enabled</span>
                      <span className={cn(
                        "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium",
                        userSyncEnabled 
                          ? "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300"
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Group Sync Enabled</span>
                      <span className={cn(
                        "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium",
                        groupSyncEnabled 
                          ? "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300"
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Sync Interval</span>
