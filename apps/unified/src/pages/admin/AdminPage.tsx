    ...
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Manage your Nova Universe platform</p>
        </div>
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className={`rounded-lg p-2 ${getSystemHealthColor()}`}>
              ...
              <div
                className={`rounded-full px-3 py-1 text-sm font-medium ${getSystemHealthColor()}`}
              >
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <h2 className="mb-4 text-xl font-semibold text-gray-900">Admin Tasks</h2>
              ...
              {adminTasks.map((task, index) => {
                ...
                return (
                  <Link
                    key={index}
                    to={task.link}
                    className="group rounded-xl border border-gray-200 bg-white p-6 transition-all duration-200 hover:border-blue-300 hover:shadow-md"
                  >
                    <div className="flex items-start space-x-4">
                      <div
                        className={`rounded-lg p-3 ${task.color} transition-transform duration-200 group-hover:scale-110`}
                      >
                        <Icon className="h-6 w-6" />
                      </div>
                ...
                {recentActivities.map((activity, index) => {
                  ...
                  return (
                    <div key={index} className="flex items-start space-x-3">
                      <div
                        className={`rounded-lg p-1.5 ${getStatusColor(activity.status)} bg-opacity-10`}
                      >
