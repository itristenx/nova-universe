    ...
    return (
      <div className="space-y-6">
        <div className="card p-12 text-center">
          ...
          <button onClick={loadSystemConfig} className="btn btn-primary mt-4">
            Retry
          </button>
        </div>
      </div>
                ...
                <div className="mt-6">
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      onChange={(e) =>
                        updateConfig('security', 'twoFactorEnabled', e.target.checked)
                      }
                      className="checkbox"
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      onChange={(e) =>
                        updateConfig('notifications', 'emailNotifications', e.target.checked)
                      }
                      className="checkbox"
                  ...
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      onChange={(e) =>
                        updateConfig('notifications', 'criticalAlerts', e.target.checked)
                      }
                      className="checkbox"
                  ...
                  <div className="flex items-center space-x-3">
                    <input
                      ...
                      onChange={(e) =>
                        updateConfig('notifications', 'systemUpdates', e.target.checked)
                      }
                      className="checkbox"
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateConfig('storage', 'maxFileSize', parseInt(e.target.value))
                      }
                      className="input"
                      min="1"
                      max="1000"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateConfig('storage', 'storageQuota', parseInt(e.target.value))
                      }
                      className="input"
                      min="1"
                      max="10000"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateConfig('storage', 'backupRetention', parseInt(e.target.value))
                      }
                      className="input"
                      min="1"
                      max="365"
