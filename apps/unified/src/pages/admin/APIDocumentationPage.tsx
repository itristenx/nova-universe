    ...
    <div className="space-y-6">
      <div className="mb-4 flex space-x-4 border-b">
        <button
          className={cn(
            'pb-2',
            activeTab === 'documentation' ? 'border-b-2 border-blue-500' : 'text-gray-500',
          )}
        ...
        <button
          className={cn(
            'pb-2',
            activeTab === 'keys' ? 'border-b-2 border-blue-500' : 'text-gray-500',
          )}
      ...
      {activeTab === 'documentation' &&
        (spec ? (
          <pre
            className="overflow-auto rounded bg-gray-50 p-4 text-sm dark:bg-gray-900"
              ...
              {apiKeys.map((key) => (
                <li key={key.id} className="flex items-center justify-between py-2">
                  ...
                  <div className="space-x-2">
                    ...
                    <button onClick={() => deleteKey(key.id)} className="text-sm text-red-600">
                      Delete
                    </button>
                  </div>
                </li>
      ...
      {showCreateModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50">
          <div className="space-y-4 rounded bg-white p-6 shadow-lg dark:bg-gray-800">
            ...
            <div className="flex justify-end space-x-2">
              ...
              <button className="rounded bg-blue-600 px-3 py-2 text-white" onClick={createKey}>
                Create
              </button>
            </div>
          </div>
