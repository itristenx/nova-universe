      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-gray-600 dark:text-gray-400">Configure SAML SSO integration</p>
          </div>
        </div>

        <div className="card p-12 text-center">
          <div className="border-primary-600 mx-auto h-8 w-8 animate-spin rounded-full border-b-2"></div>
          <p className="mt-4 text-gray-600 dark:text-gray-400">Loading SAML configuration...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-3">
          <button onClick={loadConfig} disabled={isLoading} className="btn btn-secondary">
        ...
        <div className="p-6">
          {activeTab === 'configuration' && (
            <div className="space-y-8">
              {/* Basic Configuration */}
              <div>
                <h3 className="mb-4 flex items-center space-x-2 text-lg font-medium text-gray-900 dark:text-gray-100">
                  ...
                  <div>
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        onChange={(e) =>
                          setConfig({ ...config, bypassLoginPage: e.target.checked })
                        }
                        className="text-primary-600 focus:ring-primary-500 h-4 w-4 rounded border-gray-300"
                      />
                      <label className="ml-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setConfig({ ...config, signatureAlgorithm: e.target.value })
                        }
                        className="input w-full"
                      >
                        <option value="http://www.w3.org/2001/04/xmldsig-more#rsa-sha256">
                          RSA-SHA256
                        </option>
                        <option value="http://www.w3.org/2000/09/xmldsig#rsa-sha1">RSA-SHA1</option>
                        <option value="http://www.w3.org/2001/04/xmldsig-more#rsa-sha512">
                          RSA-SHA512
                        </option>
                      </select>
                    </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  {Object.entries(config.attributeMapping).map(([key, value]) => (
                    <div key={key}>
                      <label className="mb-2 block text-sm font-medium text-gray-700 capitalize dark:text-gray-300">
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        setConfig({ ...config, autoProvisionUsers: e.target.checked })
                      }
                      className="text-primary-600 focus:ring-primary-500 h-4 w-4 rounded border-gray-300"
                    />
                    <label className="ml-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        setConfig({ ...config, groupMirroringEnabled: e.target.checked })
                      }
                      className="text-primary-600 focus:ring-primary-500 h-4 w-4 rounded border-gray-300"
                    />
                    <label className="ml-2 text-sm text-gray-600 dark:text-gray-400">
          ...
          {activeTab === 'testing' && (
            <div className="space-y-6">
              ...
              {testResult && (
                ...
                >
                  <div className="flex items-start space-x-3">
                    {testResult.success ? (
                      <CheckIcon className="h-6 w-6 flex-shrink-0 text-green-600 dark:text-green-400" />
                    ) : (
                      <XIcon className="h-6 w-6 flex-shrink-0 text-red-600 dark:text-red-400" />
                    )}
              ...
              <div className="card border-l-4 border-l-blue-500 bg-blue-50 p-4 dark:bg-blue-900/20">
                <div className="flex items-start space-x-3">
                  <InfoIcon className="h-6 w-6 flex-shrink-0 text-blue-600 dark:text-blue-400" />
                  <div>
                    <h4 className="font-medium text-gray-900 dark:text-gray-100">
                      Test Requirements
                    </h4>
          ...
          {activeTab === 'metadata' && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  <button onClick={() => copyToClipboard(metadata)} className="btn btn-secondary">
                    <CopyIcon className="h-4 w-4" />
                    Copy
                  </button>
                  <button
              ...
              <div className="card">
                <div className="border-b border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800">
                  <h4 className="font-medium text-gray-900 dark:text-gray-100">Metadata XML</h4>
                </div>
                <div className="p-4">
                  <pre className="overflow-x-auto text-sm whitespace-pre-wrap text-gray-600 dark:text-gray-400">
                    {metadata}
                  </pre>
                </div>
              </div>
              ...
              <div className="card border-l-4 border-l-amber-500 bg-amber-50 p-4 dark:bg-amber-900/20">
                <div className="flex items-start space-x-3">
                  <InfoIcon className="h-6 w-6 flex-shrink-0 text-amber-600 dark:text-amber-400" />
                  <div>
                    <h4 className="font-medium text-gray-900 dark:text-gray-100">
