              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => handleInputChange('cleanupTime', parseInt(e.target.value) || 0)}
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-nova-600 focus:ring-nova-500 border-gray-300 dark:border-gray-600 rounded"
                  />
                  <label htmlFor="catering" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
                    Catering required
                  </label>
                </div>
