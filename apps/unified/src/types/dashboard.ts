...
export interface RealTimeEvent {
  id: string
  type: 'ticket_created' | 'ticket_updated' | 'asset_checked_out' | 'space_booked' | 'alert_triggered' | 'user_login'
...
export interface CollaborationEvent {
  id: string
  type: 'user_joined' | 'user_left' | 'cursor_moved' | 'selection_changed' | 'comment_added' | 'edit_made'
  userId: string
  userName: string
  userAvatar?: string
  data: Record<string, any>
