  ...
  return (
    <main className="mx-auto max-w-2xl p-8">
      ...
      <div className="text-muted-foreground mb-4">
        {ticket.ticketId} &bull; {ticket.status} &bull; {ticket.priority}
      </div>
      ...
      <h2 className="mt-8 mb-2 font-semibold">Updates</h2>
        ...
        {updates.map((u, i) => (
          <li key={i} className="bg-muted rounded border p-2">
            <div className="text-muted-foreground mb-1 text-xs">
              {u.timestamp && new Date(u.timestamp).toLocaleString()} &bull; {u.user}
            </div>
