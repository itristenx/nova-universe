  ...
  const generateMockTickets = (): Ticket[] => {
    return [
        ...
        comments: [
          {
            ...
            author: 'Sarah Chen',
            content:
              'Hi! I&apos;ve received your ticket and am looking into the authentication issue. Can you confirm which browser you&apos;re using?',
      ...
      },
      {
        ...
        description:
          'Need Adobe Creative Suite license for graphic design work on the marketing team.',
      ...
      },
      {
        ...
        description:
          'My work laptop has become extremely slow over the past week. Takes 5+ minutes to boot and applications freeze frequently.',
        category: 'Hardware',
        ...
        comments: [
          {
            ...
            content:
              'I&apos;ve completed the system optimization. Your laptop should be running much faster now. Please test and let me know if you notice any remaining issues.',
            timestamp: '2024-08-06T16:30:00Z',
            is_internal: false,
          },
        ],
      ...
      <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <RefreshCw
              className={`h-4 w-4 ${realTimeEnabled ? 'text-green-500' : 'text-gray-400'}`}
            />
          ...
          <Dialog open={isNotificationDialogOpen} onOpenChange={setIsNotificationDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[500px]">
              ...
              <div className="space-y-6">
                {/* Delivery methods */}
                <div>
                  <h4 className="mb-4 font-medium">Delivery Methods</h4>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(value) =>
                          updateNotificationPreference('email_updates', value)
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(value) =>
                          updateNotificationPreference('sms_updates', value)
                        }
                      />
                    </div>
                  </div>
                ...
                {/* Event types */}
                <div>
                  <h4 className="mb-4 font-medium">Notification Types</h4>
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(value) =>
                          updateNotificationPreference('status_changes', value)
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(value) =>
                          updateNotificationPreference('new_comments', value)
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(value) =>
                          updateNotificationPreference('sla_warnings', value)
                        }
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(value) =>
                          updateNotificationPreference('resolution_confirmation', value)
                        }
                      />
                    </div>
                  </div>
          ...
          {/* Refresh button */}
          <Button variant="outline" size="sm" onClick={refreshTickets} disabled={refreshing}>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="mb-2 flex items-center gap-2">
                      ...
                      {ticket.sla_breach_risk && <AlertCircle className="h-4 w-4 text-red-500" />}
                    </div>
            ...
            <Tabs defaultValue="details" className="mt-6">
              ...
              <TabsContent value="details" className="mt-6">
                <div className="space-y-6">
                  {/* Progress */}
                  <div>
                    <h4 className="mb-3 font-medium">Progress</h4>
                    <div className="mb-2 flex justify-between text-sm">
                      <span>Current Status</span>
                      <span className="font-medium">
                        {getProgressPercentage(selectedTicket.status)}% Complete
                      </span>
                    </div>
                    <Progress
                      value={getProgressPercentage(selectedTicket.status)}
                      className="h-3"
                    />
                    {selectedTicket.estimated_completion && (
                      <p className="mt-2 text-sm text-gray-600">
                        Estimated completion:{' '}
                        {formatTimeRemaining(selectedTicket.estimated_completion)}
                      </p>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                      <h4 className="mb-3 font-medium">Ticket Information</h4>
                      <div className="space-y-3">
                        <div>
                    ...
                    <div>
                      <h4 className="mb-3 font-medium">Assignment</h4>
                      <div className="space-y-3">
