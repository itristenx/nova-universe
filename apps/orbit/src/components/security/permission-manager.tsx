...
const mockRoles: UserRole[] = [
  ...
  },
  {
    ...
    permissions: ['read_profile', 'edit_profile', 'view_analytics', 'manage_users', 'system_config'],
    userCount: 2,
    isDefault: false
  }
];
...
export function PermissionManager() {
  ...
  const togglePermission = (permissionId: string) => {
    setPermissions(prev => 
      prev.map(p => 
        p.id === permissionId 
          ? { ...p, enabled: !p.enabled, lastModified: new Date() }
          : p
      )
    );
  };
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-amber-700 dark:text-amber-300">
                Changes to critical permissions require additional verification and may take up to 24 hours to take effect. 
                Always review permissions carefully before making changes.
              </p>
            </div>
          </div>
        </CardContent>
