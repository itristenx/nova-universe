  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <input className="border p-2" placeholder="Tracking Number" onChange={e => setForm(f => ({ ...f, tracking_number: e.target.value }))} />
        <input className="border p-2" placeholder="Recipient ID" onChange={e => setForm(f => ({ ...f, recipient_id: e.target.value }))} />
        <input className="border p-2" placeholder="Carrier" onChange={e => setForm(f => ({ ...f, carrier: e.target.value }))} />
