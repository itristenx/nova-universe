...
if (!rootElement) {
  ...
  document.body.innerHTML = '<div style="padding: 20px; color: red; font-family: monospace;">❌ Root element not found! Check if HTML has &lt;div id="root"&gt;&lt;/div&gt;</div>'
} else {
  ...
  try {
    ...
    setTimeout(() => {
      if (rootElement.children.length === 0) {
        ...
        rootElement.innerHTML = '<div style="padding: 20px; color: red; font-family: monospace;">❌ React mounted but no content rendered. Check browser console for errors.</div>'
      } else {
