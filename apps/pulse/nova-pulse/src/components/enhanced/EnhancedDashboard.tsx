    ...
    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow">
      <div className="flex items-center justify-between">
        <div className="flex-1">
          ...
          {change && (
            <p
              className={`mt-1 inline-block rounded-full px-2 py-1 text-xs font-medium ${changeClasses[changeType]}`}
            >
              {change}
            </p>
          )}
...
export const EnhancedDashboard: React.FC<DashboardViewProps> = ({ user }) => {
  ...
  const metrics = useMemo(() => {
    ...
    const highPriorityTickets = tickets.filter(
      (t) =>
        ['high', 'critical'].includes(t.priority) && ['open', 'in_progress'].includes(t.status),
    ).length;
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-gray-600">
              {userRole === 'agent'
                ? 'Track your tickets and performance'
                : userRole === 'supervisor'
          ...
          <div className="p-6">
            <div className="space-y-4">
              ...
              {dashboard.recentActivity.length === 0 && (
                <div className="py-8 text-center text-gray-500">
                  <BarChart className="mx-auto mb-2 h-12 w-12 text-gray-300" />
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                <div className="text-center">
                  ...
                  <p className="mt-1 text-xs font-medium text-green-600">+15% from yesterday</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="mt-1 text-xs font-medium text-blue-600">+2% from last week</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="mt-1 text-xs font-medium text-purple-600">Stable</p>
                </div>
              </div>
            </div>
          </div>
