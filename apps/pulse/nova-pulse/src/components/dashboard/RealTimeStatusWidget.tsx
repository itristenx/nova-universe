...
const StatusIndicator: React.FC<StatusIndicatorProps> = ({ status, label, count, lastUpdate }) => {
  return (
    <div className="flex items-center justify-between py-2">
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          {lastUpdate && (
            <p className="text-xs text-gray-500 dark:text-gray-400">Last update: {lastUpdate}</p>
          )}
        </div>
      </div>
      {count !== undefined && (
    ...
    <Card className="w-full" shadow="sm">
      <CardBody className="p-4">
        <div className="mb-3 flex items-center justify-between">
          <h4 className="text-sm font-semibold text-gray-900 dark:text-gray-100">{queueName}</h4>
        ...
        <div className="mb-3 grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-lg font-bold text-gray-900 dark:text-gray-100">{assignedTickets}</p>
          </div>
          <div>
            <p className="text-xs text-gray-500 dark:text-gray-400">Waiting</p>
            <p className="text-lg font-bold text-gray-900 dark:text-gray-100">{waitingTickets}</p>
          </div>
        </div>
    ...
    <div className="space-y-6">
      ...
      <Card shadow="sm">
        <CardHeader className="pb-2">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Agent Status</h3>
        </CardHeader>
