...
async function checkAdminPassword() {
  try {
    ...
    console.log('  Password Hash:', adminUser.password_hash ? `${adminUser.password_hash.substring(0, 20)}...` : 'NULL');
    ...
    console.log('Old password "admin" verification:', oldPasswordValid ? '✅ Valid' : '❌ Invalid (expected)');
