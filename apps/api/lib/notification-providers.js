...
export class NotificationProviderService {
     ...
     */
    async sendTelegram(provider, message) {
     ...
     */
    async sendPushover(provider, message) {
     ...
     */
    async sendTeams(provider, message) {
     ...
     */
    async sendMatrix(provider, message) {
     ...
     */
    async sendSignal(provider, message) {
     ...
     */
    async sendGotify(provider, message) {
     ...
     */
    async sendPagerDuty(provider, message) {
     ...
     */
    async sendOpsgenie(provider, message) {
     ...
     */
    async sendPushbullet(provider, message) {
     ...
     */
    async sendLine(provider, message) {
     ...
     */
    async sendMattermost(provider, message) {
     ...
     */
    async sendRocketChat(provider, message) {
     ...
     */
    async sendFeishu(provider, message) {
        const { webhook_url } = provider.config;
        const payload = {
            ...
            card: {
                header: {
                    ...
                    template: message.severity === 'critical'
                        ? 'red'
     ...
     */
    async sendDingTalk(provider, message) {
     ...
     */
    async sendBark(provider, message) {
     ...
     * NTFY notifications
     */
    async sendNtfy(provider, message) {
     ...
     */
    async sendSplunk(provider, message) {
     ...
     */
    async sendHomeAssistant(provider, message) {
