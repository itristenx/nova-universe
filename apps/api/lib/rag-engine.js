...
import { VectorStoreFactory } from './rag-vector-stores.js';
    ...
    async addToVectorStore(chunk) {
        ...
        if (!store) {
            ...
            try {
                ...
                logger.error('Failed to add chunk to fallback vector store');
                throw error;
            }
            return;
        }
        ...
        try {
            ...
            logger.error('Failed to add chunk to vector store');
            throw error;
        }
    }
