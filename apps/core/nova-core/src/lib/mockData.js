...
export const mockUsers = [
  ...
  },
  {
    ...
    permissions: ['tickets.view', 'tickets.edit', 'tickets.comment', 'users.view', 'hr.access'],
...
export const mockLogs = [
  ...
  },
  {
    ...
    kioskId: 'kiosk-001',
    resolution:
      'Permissions updated for HR shared drive access. User can now access all required folders.',
  ...
  },
  {
    ...
    kioskId: 'kiosk-001',
    resolution:
      'Password reset completed. User notified via secure email with temporary credentials.',
...
export const mockConfig = {
  ...
  systems:
    'Desktop,Laptop,Mobile Device,Network,Printer,Software,Security,Access Request,Hardware Setup',
  urgencies: 'Low,Medium,High,Critical,Emergency',
  departments:
    'IT Support,Human Resources,Facilities,Security,Engineering,Finance,Marketing,Operations',
  ...
  },
  {
    ...
    config: {
      tenantId: crypto.randomUUID
        ? crypto.randomUUID()
        : 'tenant-' + Math.random().toString(36).substr(2, 8),
...
export const mockPermissions = [
  ...
  // Kiosk Management
  {
    ...
    description: 'Full kiosk management access',
  },
  {
    id: 6,
    name: 'kiosks.configure',
    category: 'Kiosk Management',
    description: 'Configure kiosk settings',
  },
  {
    id: 7,
    name: 'kiosks.monitor',
    category: 'Kiosk Management',
    description: 'Monitor kiosk status and health',
  },
  {
    id: 8,
    name: 'kiosks.view',
    category: 'Kiosk Management',
    description: 'View kiosk information',
  },
  ...
  // Ticket Management
  {
    ...
    description: 'View tickets and their details',
  },
  {
    id: 10,
    name: 'tickets.edit',
  ...
  // Department-Specific
  {
    ...
    description: 'Access HR-specific features and data',
  },
  {
    id: 33,
    name: 'finance.access',
    category: 'Finance Department',
    description: 'Access finance-related features',
  },
  {
    id: 34,
    name: 'facilities.access',
    category: 'Facilities Department',
    description: 'Access facilities management features',
  },
...
export const mockNotifications = [
  {
    ...
    message:
      'New critical ticket NOV-2024-006 submitted from Engineering floor - Server room temperature alert',
  ...
  },
  {
    ...
    message:
      'ServiceNow Production integration test completed successfully - All systems operational',
  ...
  },
  {
    ...
    message:
      'Your weekly support metrics report is ready for review - 98.2% satisfaction rate this week',
  ...
  },
  {
    ...
    message:
      'System maintenance scheduled for tonight at 11:00 PM EST - Expected duration: 2 hours',
...
export const delay = (ms = 200 + Math.random() * 800) =>
