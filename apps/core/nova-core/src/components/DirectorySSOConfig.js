  ...
  const renderDirectoryTab = () =>
    React.createElement(
      ...
      React.createElement(
        ...
        {
          className:
            'bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md p-4',
        },
        React.createElement(
          'div',
          { className: 'flex' },
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'p',
                null,
                'Directory integration is read-only and pulls user information for display purposes only. Nova Universe will never modify user data in your directory.',
              ),
            ),
          ),
        ),
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              Button,
              { variant: 'secondary', size: 'sm', onClick: () => openSetupWizard('directory') },
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(Select, {
              ...
              onChange: (value) => setDirectoryConfig((prev) => ({ ...prev, provider: value })),
              options: [
            ...
            directoryConfig.provider === 'scim' &&
              React.createElement(
                ...
                React.createElement(Input, {
                  ...
                  onChange: (e) =>
                    setDirectoryConfig((prev) => ({ ...prev, token: e.target.value })),
                  placeholder: 'Bearer token for SCIM API',
                  disabled: !directoryConfig.enabled,
                }),
              ),
            (directoryConfig.provider === 'ldap' ||
              directoryConfig.provider === 'activedirectory') &&
              React.createElement(
                React.Fragment,
                null,
                React.createElement(Input, {
                ...
                React.createElement(Input, {
                  ...
                  onChange: (e) =>
                    setDirectoryConfig((prev) => ({ ...prev, baseDN: e.target.value })),
                ...
                React.createElement(Input, {
                  ...
                  onChange: (e) =>
                    setDirectoryConfig((prev) => ({ ...prev, bindDN: e.target.value })),
                ...
                React.createElement(Input, {
                  ...
                  onChange: (e) =>
                    setDirectoryConfig((prev) => ({ ...prev, bindPassword: e.target.value })),
          ...
          React.createElement(
            ...
            React.createElement(Input, {
              ...
              onChange: (e) =>
                setDirectoryConfig((prev) => ({ ...prev, userFilter: e.target.value })),
            ...
            React.createElement(Input, {
              ...
              onChange: (e) =>
                setDirectoryConfig((prev) => ({
                  ...prev,
                  syncInterval: parseInt(e.target.value) || 3600,
                })),
              disabled: !directoryConfig.enabled,
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  'li',
                  null,
                  '\u2022 User data is never modified in your directory',
                ),
  ...
  const renderSSOTab = () =>
    React.createElement(
      ...
      React.createElement(
        ...
        {
          className:
            'bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-md p-4',
        },
        React.createElement(
          'div',
          { className: 'flex' },
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'p',
                null,
                'SSO provides an additional login method alongside local authentication. Users can still log in with their email/password even when SSO is enabled. Contact your system administrator to configure SAML SSO.',
              ),
            ),
          ),
        ),
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Button,
            { variant: 'secondary', size: 'sm', onClick: () => openSetupWizard('sso') },
            React.createElement(CogIcon, { className: 'h-4 w-4 mr-2' }),
            'Setup Guide',
          ),
        ),
        React.createElement(
          ...
          ssoConfig.enabled &&
            React.createElement(
              ...
              React.createElement(Select, {
                ...
                onChange: (value) => setSsoConfig((prev) => ({ ...prev, provider: value })),
                options: [
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement('textarea', {
                      ...
                      rows: 4,
                      className:
                        'w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-gray-100',
                    }),
                  ),
                ),
          ...
          React.createElement(
            ...
            ssoConfig.enabled
              ? React.createElement(CheckCircleIcon, { className: 'h-5 w-5 text-green-500' })
              : React.createElement(XCircleIcon, { className: 'h-5 w-5 text-gray-400' }),
            React.createElement(
              'span',
              {
                className: `text-sm ${ssoConfig.enabled ? 'text-green-700 dark:text-green-300' : 'text-gray-500 dark:text-gray-400'}`,
              },
              'SSO ',
          ...
          ssoConfig.enabled &&
            React.createElement(
              ...
              React.createElement(
                'h4',
                { className: 'text-sm font-medium text-green-800 dark:text-green-200 mb-3' },
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'code',
                    { className: 'ml-2 bg-green-100 dark:bg-green-800 px-1 rounded' },
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'p',
                    null,
                    'Users can choose between local login (email/password) or SSO on the login page.',
                  ),
                ),
              ),
            ),
          React.createElement(
            'div',
            { className: 'bg-blue-50 dark:bg-blue-900/20 p-4 rounded-md' },
            React.createElement(
              'h4',
            ...
            React.createElement(
              ...
              React.createElement(
                'div',
                null,
                'Configure your SSO provider above to enable single sign-on for users.',
              ),
              React.createElement(
                'div',
                null,
                'Users will be able to choose between local login (email/password) or SSO on the login page.',
              ),
              React.createElement(
                'div',
                null,
                'SSO provides an additional authentication method alongside existing local accounts.',
              ),
            ),
          ),
        ),
        React.createElement(
          ...
          React.createElement(
            Button,
            { variant: 'primary', onClick: saveSSOConfig, disabled: saving, isLoading: saving },
    ...
    React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'p',
                null,
                'SCIM 2.0 endpoints allow your identity provider to automatically provision and deprovision users.',
              ),
            ),
          ),
        ),
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Button,
            { variant: 'secondary', size: 'sm', onClick: () => openSetupWizard('scim') },
            React.createElement(CogIcon, { className: 'h-4 w-4 mr-2' }),
            'Setup Guide',
          ),
        ),
        React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(Checkbox, {
                    ...
                    onChange: (checked) =>
                      setScimConfig((prev) => ({ ...prev, autoProvisioning: checked })),
                  }),
                  React.createElement(
                    'p',
                    { className: 'text-xs text-gray-500 mt-1' },
                    'Automatically create users when provisioned via SCIM',
                  ),
                ),
                React.createElement(
                  'div',
                  ...
                  React.createElement(Checkbox, {
                    ...
                    onChange: (checked) =>
                      setScimConfig((prev) => ({ ...prev, autoDeprovisioning: checked })),
                  }),
                  React.createElement(
                    'p',
                    { className: 'text-xs text-gray-500 mt-1' },
                    'Automatically disable users when deprovisioned via SCIM',
                  ),
                ),
                React.createElement(Input, {
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      'code',
                      { className: 'ml-2 bg-gray-100 dark:bg-gray-700 px-1 rounded' },
                      window.location.origin,
                      '/scim/v2',
                    ),
                  ),
          ...
          React.createElement(
            ...
            React.createElement(
              'span',
              {
                className: `text-sm ${scimConfig.enabled ? 'text-green-700 dark:text-green-300' : 'text-gray-500 dark:text-gray-400'}`,
              },
              'SCIM 2.0 ',
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'div',
                null,
                '1. Enable SCIM provisioning above and set a bearer token',
              ),
              React.createElement(
                'div',
                null,
                '2. Configure your identity provider with the SCIM endpoints shown above',
              ),
              React.createElement(
                'div',
                null,
                '3. Use the bearer token as an Authorization header in your IdP',
              ),
              React.createElement(
                'div',
                null,
                '4. Test user provisioning to ensure everything works correctly',
              ),
            ),
          ),
        ),
        React.createElement(
          ...
          React.createElement(
            Button,
            { variant: 'primary', onClick: saveSCIMConfig, disabled: saving, isLoading: saving },
        ...
        setupType === 'directory' &&
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'li',
                    null,
                    '\u2022 Provide authentication credentials (token or bind DN/password)',
                  ),
              ...
              React.createElement(
                'div',
                { className: 'bg-purple-50 dark:bg-purple-900/20 p-4 rounded-md' },
                React.createElement(
                  'h4',
                ...
                React.createElement(
                  'ul',
                  { className: 'text-sm text-purple-700 dark:text-purple-300 space-y-1' },
                  React.createElement(
                    'li',
                    null,
                  ...
                  React.createElement(
                    'li',
                    null,
                    '\u2022 Users will now be searchable in kiosk forms',
                  ),
                ),
              ),
            ),
        ...
        setupType === 'sso' &&
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'div',
                { className: 'bg-amber-50 dark:bg-amber-900/20 p-4 rounded-md' },
                React.createElement(
                  'h4',
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      'code',
                      { className: 'bg-amber-100 dark:bg-amber-800 px-1 rounded' },
                      '.env',
                    ),
                    ' file:',
                  ),
                  React.createElement(
                    ...
                    {
                      className:
                        'bg-amber-100 dark:bg-amber-800 p-2 rounded text-xs overflow-x-auto',
                    },
...
SESSION_SECRET=your-secure-session-secret`,
              ...
              React.createElement(
                'div',
                { className: 'bg-red-50 dark:bg-red-900/20 p-4 rounded-md' },
                React.createElement(
                  'h4',
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'pre',
                    { className: 'bg-green-100 dark:bg-green-800 p-2 rounded text-xs' },
              ...
              React.createElement(
                ...
                React.createElement(
                  'div',
                  { className: 'text-sm text-blue-700 dark:text-blue-300 space-y-2' },
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      'li',
                      null,
                      '\u2022 Authentication: Bearer Token (use your SCIM_TOKEN)',
                    ),
                    React.createElement(
                      'li',
                      null,
                      '\u2022 Supported operations: Create, Read, Update, Delete users',
                    ),
                  ),
                ),
              ),
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    {
                      className:
                        'bg-purple-100 dark:bg-purple-800 p-2 rounded text-xs mt-2 overflow-x-auto',
                    },
  ...
  -d '{"userName":"test@example.com","displayName":"Test User"}'`,
        ...
        React.createElement(
          ...
          React.createElement(
            Button,
            { variant: 'secondary', onClick: () => setShowSetupModal(false) },
            'Close',
          ),
        ),
      ),
