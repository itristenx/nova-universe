...
export const PasskeyManagement = ({ showTitle = true }) => {
  ...
  return React.createElement(
    ...
    !window.PublicKeyCredential &&
      React.createElement(
        Card,
        { className: 'p-4 border-amber-200 bg-amber-50 dark:bg-amber-900/20' },
        React.createElement(
          'div',
          { className: 'flex' },
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'p',
                null,
                'Your browser does not support WebAuthn. Please use a modern browser like Chrome, Firefox, Safari, or Edge to use passkeys.',
              ),
            ),
          ),
        ),
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    {
                      className:
                        'w-10 h-10 bg-primary-100 dark:bg-primary-900 rounded-lg flex items-center justify-center',
                    },
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    {
                      className:
                        'flex items-center space-x-4 text-xs text-gray-500 dark:text-gray-400',
                    },
                    React.createElement(
                      'span',
                      null,
    ...
    React.createElement(
      Card,
      { className: 'p-4 bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800' },
      React.createElement(
        'div',
        { className: 'flex' },
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'li',
                null,
                '\u2022 More secure than passwords and resistant to phishing',
              ),
              React.createElement(
                'li',
                null,
                '\u2022 Can be used for admin login and kiosk authentication',
              ),
            ),
          ),
        ),
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Button,
            { variant: 'secondary', onClick: () => setDeleteModal({ isOpen: false }) },
            'Cancel',
          ),
          React.createElement(
            Button,
