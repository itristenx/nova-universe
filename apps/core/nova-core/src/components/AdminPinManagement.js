  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Button,
            { variant: 'secondary', onClick: () => setShowTestModal(true) },
            'Test PIN',
          ),
          React.createElement(
            Button,
            { onClick: savePinConfiguration, disabled: loading },
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            kiosks.length === 0
              ? React.createElement(
                  'div',
                  { className: 'bg-gray-50 rounded-md p-6 text-center' },
              ...
              : kiosks.map((kiosk) =>
                  React.createElement(
                    'div',
                    { key: kiosk.id, className: 'bg-gray-50 rounded-md p-3' },
                    React.createElement(
                      'div',
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          'span',
                          {
                            className: `inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${kiosk.active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}`,
                          },
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            kiosks.map((kiosk) =>
              React.createElement('option', { key: kiosk.id, value: kiosk.id }, kiosk.id),
            ),
          ),
        ),
        testResult &&
          React.createElement(
            'div',
            {
              className: `p-3 rounded-md ${testResult.valid ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}`,
            },
            React.createElement(
              'div',
              { className: 'flex items-center space-x-2 mb-2' },
              testResult.valid
                ? React.createElement(CheckCircleIcon, { className: 'h-5 w-5 text-green-600' })
                : React.createElement(ExclamationTriangleIcon, {
      ...
      React.createElement(
        ...
        React.createElement(
          Button,
          { onClick: validatePinInput, disabled: testPinValue.length !== 6 || loading },
