...
export const Sidebar = ({ isOpen, onClose }) => {
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      {
        className: `fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`,
      },
      React.createElement(
        'div',
        ...
        React.createElement(
          ...
          {
            className:
              'flex flex-col items-center px-6 py-4 border-b border-gray-200 dark:border-gray-700',
          },
          React.createElement(
            'div',
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                {
                  className:
                    'h-8 w-8 bg-primary-600 dark:bg-primary-500 rounded-full flex items-center justify-center',
                },
                React.createElement(
                  'span',
            ...
            React.createElement(
              'button',
              {
                ...
                className:
                  'ml-3 flex-shrink-0 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300',
                title: 'Logout',
              },
