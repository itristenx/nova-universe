      ...
      React.createElement(
        ...
        React.createElement(
          'button',
          {
            type: 'button',
            className:
              'lg:hidden -ml-2 mr-2 h-10 w-10 inline-flex items-center justify-center rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500',
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('div', {
              className: `h-2 w-2 rounded-full ${getStatusColor(currentStatus)}`,
            }),
            React.createElement(
              'span',
            ...
            React.createElement(ChevronDownIcon, {
              className: `h-3 w-3 text-gray-500 dark:text-gray-400 transition-transform duration-200 ${isDropdownOpen ? 'rotate-180' : ''}`,
            }),
          ),
          isDropdownOpen &&
            React.createElement(
              ...
              {
                className:
                  'absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 dark:ring-gray-600 z-50',
              },
              React.createElement(
                'div',
                { className: 'py-1' },
                React.createElement(
                  'button',
                  {
                    ...
                    disabled: loading,
                    className: `w-full text-left px-4 py-2 text-sm flex items-center space-x-2 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 ${currentStatus === 'open' ? 'bg-green-50 dark:bg-green-900 text-green-700 dark:text-green-300' : 'text-gray-700 dark:text-gray-300'}`,
                  },
                ...
                React.createElement(
                  'button',
                  {
                    ...
                    disabled: loading,
                    className: `w-full text-left px-4 py-2 text-sm flex items-center space-x-2 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 ${currentStatus === 'closed' ? 'bg-red-50 dark:bg-red-900 text-red-700 dark:text-red-300' : 'text-gray-700 dark:text-gray-300'}`,
                  },
                ...
                React.createElement(
                  'button',
                  {
                    ...
                    disabled: loading,
                    className: `w-full text-left px-4 py-2 text-sm flex items-center space-x-2 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 ${currentStatus === 'meeting' ? 'bg-purple-50 dark:bg-purple-900 text-purple-700 dark:text-purple-300' : 'text-gray-700 dark:text-gray-300'}`,
                  },
                ...
                React.createElement(
                  'button',
                  {
                    ...
                    disabled: loading,
                    className: `w-full text-left px-4 py-2 text-sm flex items-center space-x-2 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 ${currentStatus === 'brb' ? 'bg-yellow-50 dark:bg-yellow-900 text-yellow-700 dark:text-yellow-300' : 'text-gray-700 dark:text-gray-300'}`,
                  },
                ...
                React.createElement(
                  'button',
                  {
                    ...
                    disabled: loading,
                    className: `w-full text-left px-4 py-2 text-sm flex items-center space-x-2 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 ${currentStatus === 'lunch' ? 'bg-orange-50 dark:bg-orange-900 text-orange-700 dark:text-orange-300' : 'text-gray-700 dark:text-gray-300'}`,
                  },
                ...
                React.createElement(
                  'button',
                  {
                    ...
                    disabled: loading,
                    className: `w-full text-left px-4 py-2 text-sm flex items-center space-x-2 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 ${currentStatus === 'unavailable' ? 'bg-orange-50 dark:bg-orange-900 text-orange-700 dark:text-orange-300' : 'text-gray-700 dark:text-gray-300'}`,
                  },
                  React.createElement('div', { className: 'h-2 w-2 rounded-full bg-orange-500' }),
                  React.createElement('span', null, 'Status Unavailable'),
                ),
                React.createElement('div', {
                  className: 'border-t border-gray-100 dark:border-gray-600 my-1',
                }),
                React.createElement(
                  'button',
                  {
                    ...
                    disabled: loading,
                    className:
                      'w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50',
                  },
        ...
        React.createElement(
          'button',
          {
            ...
            className:
              'flex items-center space-x-2 hover:bg-gray-100 dark:hover:bg-gray-700 px-2 py-1 rounded-md transition-colors',
        ...
        React.createElement(
          'button',
          {
            type: 'button',
            className:
              'relative p-2 text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 rounded-md',
          },
          ...
          React.createElement('span', {
            className:
              'absolute top-0 right-0 block h-2 w-2 rounded-full bg-red-400 ring-2 ring-white dark:ring-gray-800',
          }),
        ),
      ),
    ),
    React.createElement(ServerConnectionModal, {
