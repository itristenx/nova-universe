...
export const KioskConfigurationModal = ({ isOpen, onClose, kiosk, globalConfig, onUpdate }) => {
  ...
  return React.createElement(
    Modal,
    { isOpen: isOpen, onClose: onClose, title: `Configure ${kiosk.id}`, size: 'xl' },
    React.createElement(
      'div',
      { className: 'space-y-6' },
      React.createElement(
        'div',
        {
          className: `border rounded-md p-4 ${currentlyUsingGlobal ? 'bg-blue-50 border-blue-200' : 'bg-orange-50 border-orange-200'}`,
        },
        React.createElement(
          'div',
          { className: 'flex items-start space-x-3' },
          currentlyUsingGlobal
            ? React.createElement(CheckCircleIcon, { className: 'h-5 w-5 text-blue-500 mt-0.5' })
          ...
          React.createElement(
            ...
            React.createElement(
              'h3',
              {
                className: `text-sm font-medium ${currentlyUsingGlobal ? 'text-blue-800' : 'text-orange-800'}`,
              },
              'Configuration Mode: ',
            ...
            React.createElement(
              'div',
              {
                className: `mt-2 text-sm ${currentlyUsingGlobal ? 'text-blue-700' : 'text-orange-700'}`,
              },
              currentlyUsingGlobal
                ? React.createElement(
                    'p',
                    null,
                    'This kiosk uses global configuration settings. Any overrides you create will switch it to individual mode.',
                  )
                : React.createElement(
                    'p',
                    null,
                ...
                tabs.map((tab) =>
                  React.createElement(
                    ...
                    React.createElement(tab.icon, {
                      className: `-ml-0.5 mr-2 h-5 w-5 ${activeTab === tab.id ? 'text-primary-500' : 'text-gray-400 group-hover:text-gray-500'}`,
                    }),
                    tab.name,
                    hasOverride(tab.id) &&
                      React.createElement(
                        ...
                        {
                          className:
                            'ml-2 inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-orange-100 text-orange-800',
                        },
                        'Override',
                      ),
                  ),
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        Button,
                        { onClick: () => saveOverride('status'), disabled: saving, size: 'sm' },
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        Button,
                        { onClick: () => saveOverride('schedule'), disabled: saving, size: 'sm' },
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        Button,
                        { onClick: () => saveOverride('branding'), disabled: saving, size: 'sm' },
