        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700 dark:text-blue-300">
              <p>
                Directory integration is read-only and pulls user information for display purposes
                only. Nova Universe will never modify user data in your directory.
              </p>
            </div>
          </div>
        </div>
      ...
      <Card className="p-6">
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex space-x-2">
            <Button variant="secondary" size="sm" onClick={() => openSetupWizard('directory')}>
            ...
            {directoryConfig.enabled && (
              <Button
                ...
                disabled={testing}
              >
                <ArrowPathIcon className={`mr-2 h-4 w-4 ${testing ? 'animate-spin' : ''}`} />
                Test Connection
              </Button>
            )}
          </div>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <div className="space-y-4">
            ...
            <Select
              ...
              onChange={(value) =>
                setDirectoryConfig((prev) => ({ ...prev, provider: value as any }))
              }
              options={[
    ...
    <div className="space-y-6">
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-amber-700 dark:text-amber-300">
              <p>
                SSO provides an additional login method alongside local authentication. Users can
                still log in with their email/password even when SSO is enabled. Contact your system
                administrator to configure SAML SSO.
              </p>
            </div>
          </div>
        </div>
      ...
      <Card className="p-6">
        <div className="mb-6 flex items-center justify-between">
          ...
          <Button variant="secondary" size="sm" onClick={() => openSetupWizard('sso')}>
            <CogIcon className="mr-2 h-4 w-4" />
            Setup Guide
          </Button>
        </div>
        ...
        <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="focus:ring-primary-500 focus:border-primary-500 w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
                    />
                  </div>
                </div>
              )}
            ...
            <div className="rounded-md bg-green-50 p-4 dark:bg-green-900/20">
              ...
              <div className="space-y-2 text-xs">
                <div>
                  ...
                  <code className="ml-2 rounded bg-green-100 px-1 dark:bg-green-800">
          ...
          <div className="rounded-md bg-blue-50 p-4 dark:bg-blue-900/20">
            ...
            <div className="space-y-1 text-xs text-blue-700 dark:text-blue-300">
              ...
              <div>
                Users will be able to choose between local login (email/password) or SSO on the
                login page.
              </div>
              <div>
        ...
        <div className="mt-6 flex justify-end">
          <Button variant="primary" onClick={saveSSOConfig} disabled={saving} isLoading={saving}>
    ...
    <div className="space-y-6">
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-green-700 dark:text-green-300">
              <p>
                SCIM 2.0 endpoints allow your identity provider to automatically provision and
                deprovision users.
              </p>
            </div>
          </div>
      ...
      <Card className="p-6">
        <div className="mb-6 flex items-center justify-between">
          ...
          <Button variant="secondary" size="sm" onClick={() => openSetupWizard('scim')}>
            <CogIcon className="mr-2 h-4 w-4" />
            Setup Guide
          </Button>
        </div>
              ...
              <div className="rounded-md bg-gray-50 p-4 dark:bg-gray-800">
                ...
                <div className="space-y-2 text-xs">
                  <div>
                    ...
                    <code className="ml-2 rounded bg-gray-100 px-1 dark:bg-gray-700">
        ...
        <div className="mt-6 flex justify-end">
          <Button variant="primary" onClick={saveSCIMConfig} disabled={saving} isLoading={saving}>
            ...
            <div className="space-y-3">
              <div className="rounded-md bg-blue-50 p-4 dark:bg-blue-900/20">
                ...
                <ul className="space-y-1 text-sm text-blue-700 dark:text-blue-300">
                  <li>
                    • <strong>SCIM 2.0:</strong> For modern identity providers (Okta, Azure AD,
                    etc.)
                  </li>
                  <li>
                    • <strong>LDAP:</strong> For traditional LDAP directories
                  </li>
                  <li>
                    • <strong>Active Directory:</strong> For Microsoft Active Directory
                  </li>
                </ul>
              </div>
            ...
            <div className="space-y-3">
              <div className="rounded-md bg-amber-50 p-4 dark:bg-amber-900/20">
                ...
                <div className="space-y-2 text-sm text-amber-700 dark:text-amber-300">
                  ...
                  <pre className="overflow-x-auto rounded bg-amber-100 p-2 text-xs dark:bg-amber-800">
...
SESSION_SECRET=your-secure-session-secret`}
              ...
              <div className="rounded-md bg-red-50 p-4 dark:bg-red-900/20">
                ...
                <p className="text-sm text-red-700 dark:text-red-300">
                  Server restart is required for SSO changes to take effect. Contact your system
                  administrator.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="rounded-md bg-green-50 p-4 dark:bg-green-900/20">
                ...
                <div className="space-y-2 text-sm text-green-700 dark:text-green-300">
                  ...
                  <pre className="rounded bg-green-100 p-2 text-xs dark:bg-green-800">
              ...
              <div className="rounded-md bg-purple-50 p-4 dark:bg-purple-900/20">
                ...
                <div className="text-sm text-purple-700 dark:text-purple-300">
                  ...
                  <pre className="mt-2 overflow-x-auto rounded bg-purple-100 p-2 text-xs dark:bg-purple-800">
