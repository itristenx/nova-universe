...
export const ModuleManagementPage = () => {
  ...
  const getHealthIcon = (status) => {
    switch (status) {
      ...
      case 'error':
        return React.createElement(XCircleIcon, { className: 'h-4 w-4 text-red-500' });
      default:
        return React.createElement(ClockIcon, { className: 'h-4 w-4 text-gray-400' });
    }
  };
  ...
  const getCategoryIcon = (category) => {
    switch (category) {
      case 'Core':
        return React.createElement(PuzzlePieceIcon, { className: 'h-4 w-4' });
      case 'Security':
        return React.createElement(ShieldCheckIcon, { className: 'h-4 w-4' });
      case 'Communication':
        return React.createElement(InformationCircleIcon, { className: 'h-4 w-4' });
      default:
        return React.createElement(CogIcon, { className: 'h-4 w-4' });
    }
  };
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        Button,
        {
          color: 'primary',
          variant: 'flat',
          startContent: React.createElement(ArrowPathIcon, { className: 'h-4 w-4' }),
    ...
    React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    Chip,
                    { color: getCategoryColor(category), size: 'sm', variant: 'flat' },
                  ...
                  categoryModules.map((module) =>
                    React.createElement(
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          Button,
                          { size: 'sm', variant: 'flat', onPress: () => openModuleDetails(module) },
                          'Configure',
                        ),
      ...
      React.createElement(
        Tab,
        { key: 'health', title: 'Health Monitor' },
        React.createElement(
          Card,
          null,
          React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              modules.map((module) =>
                React.createElement(
                  'div',
                  { key: module.key, className: 'p-4 border border-gray-200 rounded-lg' },
                  React.createElement(
                    'div',
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement('span', null, selectedModule?.name, ' Configuration'),
            ),
          ),
          React.createElement(
            ModalBody,
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      Chip,
                      { size: 'sm', color: getCategoryColor(selectedModule.category) },
                  ...
                  React.createElement(
                    ...
                    React.createElement('div', null, selectedModule.health.uptime, '%'),
                  ),
                ),
                  ...
                  React.createElement(
                    ...
                    selectedModule.configurations.map((config) =>
                      React.createElement(
                        ...
                        config.type === 'boolean'
                          ? React.createElement(Switch, { isSelected: config.value })
                          : config.type === 'select'
                            ? React.createElement(
                                Select,
                                {
                                ...
                                (config.options || []).map((option) =>
                                  React.createElement(SelectItem, { key: option }, option),
                                ),
                              )
                            : config.type === 'number'
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        ...
                        selectedModule.dependencies.map((dep) =>
                          React.createElement(Chip, { key: dep, size: 'sm', variant: 'flat' }, dep),
                        ),
                      ),
                    ),
                  ),
