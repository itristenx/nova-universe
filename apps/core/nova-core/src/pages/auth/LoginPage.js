  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'mx-auto h-24 w-48 flex items-center justify-center mb-8' },
        ...
        React.createElement(
          'h2',
          { className: 'mt-6 text-center text-3xl font-bold text-gray-900 dark:text-gray-100' },
      ...
      React.createElement(
        ...
        React.createElement(
          'button',
          {
            ...
            className:
              'flex items-center space-x-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full px-3 py-1 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors',
