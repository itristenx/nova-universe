...
export const UsersPage = () => {
  ...
  return React.createElement(
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          React.createElement(
                            'div',
                            {
                              className: `h-8 w-8 rounded-full flex items-center justify-center ${user.disabled ? 'bg-gray-400' : 'bg-primary-600'}`,
                            },
                            React.createElement(
                              'span',
    ...
    React.createElement(
      Modal,
      { isOpen: showCreateModal, onClose: closeModals, title: 'Create New User', size: 'md' },
      React.createElement(
        'div',
        { className: 'space-y-4' },
        React.createElement(Input, {
