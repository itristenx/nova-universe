...
const KnowledgeDetailPage = () => {
  ...
  if (!article) return React.createElement('div', null, 'Article not found.');
  return React.createElement(
    ...
    React.createElement(
      ...
      isEditor &&
        React.createElement(
          Button,
          { variant: 'secondary', onClick: () => navigate(`/knowledge/${slug}/edit`) },
          'Edit',
        ),
    ),
    React.createElement(
    ...
    React.createElement(
      ...
      comments.length === 0 &&
        React.createElement('div', { className: 'text-sm text-gray-500' }, 'No comments yet.'),
      comments.map((c) =>
        React.createElement(
          'div',
          { key: c.id, className: 'border-b py-2 text-sm' },
          React.createElement(
            'div',
      ...
      user &&
        React.createElement(
          ...
          React.createElement(
            Button,
            { variant: 'primary', onClick: addComment, disabled: !comment.trim() },
            'Post Comment',
          ),
        ),
    ),
