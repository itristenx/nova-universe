...
const KnowledgeEditPage = () => {
    ...
    if (!isEditor) {
        return React.createElement("div", { className: "p-8 text-center" }, "You do not have permission to edit articles.");
    }
    ...
    return (React.createElement("div", { className: "space-y-6" },
        React.createElement("h1", { className: "text-2xl font-bold text-gray-900" }, isEdit ? 'Edit Article' : 'New Article'),
        React.createElement(Card, { className: "p-4" },
            React.createElement("form", { onSubmit: handleSubmit, className: "space-y-4" },
                !isEdit && (React.createElement(Input, { label: "Title", value: title, onChange: e => setTitle(e.target.value), required: true })),
