...
export const NotificationsPage = () => {
  ...
  const getNotificationIcon = (type, level) => {
    ...
    switch (type) {
      ...
      case 'ticket':
        return React.createElement(ChatBubbleBottomCenterTextIcon, {
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'p-3 rounded-lg bg-yellow-500' },
            React.createElement(ExclamationTriangleIcon, { className: 'h-6 w-6 text-white' }),
          ),
          React.createElement(
            'div',
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        ...
                        React.createElement('span', null, 'Type: ', notification.type),
                        notification.level &&
                          React.createElement('span', null, 'Level: ', notification.level),
                        React.createElement(
                          'span',
                          null,
                          'Created: ',
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  'p',
                  null,
                  'Create real-time notifications that will be displayed on all active kiosks. Notifications appear as non-dismissible overlays and are automatically streamed to kiosks via Server-Sent Events.',
                ),
              ),
            ),
          ),
