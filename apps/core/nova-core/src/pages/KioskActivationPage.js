...
export const KioskActivationPage = () => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      systemsLoading
        ? React.createElement('div', { className: 'text-center py-8' }, 'Loading systems...')
        : React.createElement(
            'div',
            ...
            (systems || []).map((system) =>
              React.createElement(
                'div',
                {
                  key: system,
                  className:
                    'flex items-center justify-between bg-gray-50 px-3 py-2 rounded-lg border',
                },
                React.createElement(
                  'span',
    ...
    React.createElement(
      ...
      loading
        ? React.createElement('div', { className: 'text-center py-8' }, 'Loading activations...')
