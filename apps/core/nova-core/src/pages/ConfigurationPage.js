  ...
  return React.createElement(
            ...
            React.createElement(
              ...
              configSummary &&
                Object.entries(configSummary.overridesByType).map(([type, count]) =>
                  React.createElement(
                    'div',
                    { key: type, className: 'flex justify-between items-center' },
                    React.createElement(
                      'span',
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(ScheduleManager, {
              ...
              onSave: (newSchedule) => updateGlobalConfig({ defaultSchedule: newSchedule }),
              showEnabled: true,
            }),
          ),
          React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      ...
                      kiosk.hasOverrides
                        ...
                        : React.createElement('span', { className: 'text-gray-500' }, 'None'),
                    ),
                    React.createElement(
                      'td',
                      { className: 'px-6 py-4 whitespace-nowrap' },
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        Button,
                        { variant: 'secondary', size: 'sm', onClick: () => openKioskConfig(kiosk) },
                        'Configure',
                      ),
                    ),
                  ),
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(ExclamationTriangleIcon, {
            className: 'h-6 w-6 text-orange-500 mt-0.5',
          }),
          React.createElement(
            'div',
            null,
            React.createElement(
              ...
              'This action will reset all kiosks to use global configuration settings, removing all individual overrides.',
            ),
            React.createElement(
              'p',
      ...
      React.createElement(
        ...
        React.createElement(
          Button,
          { variant: 'secondary', onClick: () => setShowResetModal(false) },
          'Cancel',
        ),
        React.createElement(
          Button,
          { variant: 'danger', onClick: resetAllToGlobal },
          'Reset All Kiosks',
        ),
      ),
    ),
    selectedKiosk &&
      globalConfig &&
      React.createElement(KioskConfigurationModal, {
