  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Button,
          { variant: 'secondary', onClick: () => setShowSetupWizard(true) },
          React.createElement(CogIcon, { className: 'h-4 w-4 mr-2' }),
          'Setup Wizard',
        ),
        React.createElement(
          Button,
          { variant: 'secondary', onClick: () => setShowMetadataParser(true) },
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        config.enabled
          ? React.createElement(CheckCircleIcon, { className: 'h-5 w-5 text-green-500 mr-3' })
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement('textarea', {
                  ...
                  rows: 6,
                  className:
                    'w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-gray-100 font-mono text-sm',
                }),
                React.createElement(
                  'p',
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  Button,
                  { size: 'sm', variant: 'default', onClick: generateMetadata },
                  'Generate & Copy',
                ),
              ),
            ),
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              Button,
              { variant: 'secondary', onClick: loadConfig, disabled: loading },
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                testResult.success
                  ...
                  : React.createElement(XCircleIcon, { className: 'h-5 w-5 text-red-500 mr-2' }),
                React.createElement(
                  'h4',
                  {
                    className: `font-medium ${
              ...
              testResult.details &&
                React.createElement(
                  ...
                  testResult.details.userInfo &&
                    React.createElement(
                      'div',
                      { className: 'mt-4 p-3 bg-gray-100 dark:bg-gray-700 rounded' },
                      React.createElement(
                        'h6',
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'li',
                    null,
                    '\u2022 Ensure all required fields are configured before testing',
                  ),
                  React.createElement(
                    'li',
                    null,
                    '\u2022 Test with a non-production user account first',
                  ),
                  React.createElement(
                    'li',
                    null,
                    '\u2022 Verify attribute mappings return expected user data',
                  ),
                  React.createElement(
                    'li',
                    null,
    ...
    React.createElement(
      ...
      React.createElement(
        Button,
        { onClick: saveConfig, disabled: saving, isLoading: saving },
        'Save Configuration',
      ),
    ),
    showSetupWizard &&
      React.createElement(
        ...
        React.createElement(
          ...
          {
            className:
              'bg-white dark:bg-gray-800 rounded-lg p-6 max-w-2xl w-full mx-4 max-h-screen overflow-y-auto',
          },
          React.createElement(
            'div',
            ...
            React.createElement(
              Button,
              { variant: 'default', onClick: () => setShowSetupWizard(false) },
              '\u00D7',
            ),
          ),
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'code',
                    { className: 'bg-green-100 dark:bg-green-800 px-1 rounded' },
                    config.spEntityId,
                  ),
                ),
                React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  'li',
                  null,
                  '\u2022 Use the test functionality in this interface',
                ),
                React.createElement(
                  'li',
                  null,
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              Button,
              { variant: 'default', onClick: () => setShowMetadataParser(false) },
              '\u00D7',
            ),
          ),
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                Button,
                { variant: 'secondary', onClick: () => setShowMetadataParser(false) },
                'Cancel',
              ),
