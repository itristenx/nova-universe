  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          {
            className:
              'flex items-center space-x-3 bg-white border border-gray-200 rounded-lg px-4 py-2',
          },
          React.createElement(
            'label',
        ...
        React.createElement(
          Button,
          { variant: 'primary', onClick: openActivationModal },
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  kiosks.map((kiosk) =>
                    React.createElement(
                      'tr',
                      { key: kiosk.id, className: 'hover:bg-gray-50' },
                      React.createElement(
                        'td',
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          'span',
                          {
                            className: `inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${kiosk.active ? 'bg-green-100 text-green-800 border-green-200' : 'bg-gray-100 text-gray-800 border-gray-200'}`,
                          },
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          'span',
                          {
                            className: `inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${getStatusColor(kiosk.effectiveConfig.currentStatus)}`,
                          },
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            'Generate a QR code and activation code for new kiosk registration. The kiosk administrator can scan the QR code or enter the activation code manually.',
          ),
        ),
        !activationData
          ? React.createElement(
          ...
          : React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  {
                    className:
                      'mx-auto mb-4 p-4 bg-white border-2 border-gray-200 rounded-lg inline-block',
                  },
                  activationData.qrCode
                    ...
                    : React.createElement(
                        ...
                        {
                          className:
                            'w-48 h-48 bg-gray-100 rounded flex items-center justify-center',
                        },
                        React.createElement(
                          'div',
                          { className: 'text-center' },
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'div',
                    { className: 'flex-1 p-3 bg-gray-50 border border-gray-200 rounded-md' },
                    React.createElement(
                      'code',
      ...
      React.createElement(
        ...
        React.createElement(
          Button,
          { variant: 'secondary', onClick: closeActivationModal },
          'Close',
        ),
      ),
    ),
    React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'span',
                {
                  className: `inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${selectedKiosk.active ? 'bg-green-100 text-green-800 border-green-200' : 'bg-gray-100 text-gray-800 border-gray-200'}`,
                },
            ...
            React.createElement(
              ...
              React.createElement(
                'span',
                {
                  className: `inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${getStatusColor(selectedKiosk.effectiveConfig.currentStatus)}`,
                },
            ...
            React.createElement(
              ...
              React.createElement(
                'p',
                { className: 'text-sm text-gray-900' },
                formatDate(selectedKiosk.lastSeen),
              ),
            ),
            React.createElement(
              'div',
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                Button,
                { variant: 'secondary', onClick: () => refreshKioskConfig(selectedKiosk.id) },
                React.createElement(ArrowPathIcon, { className: 'h-4 w-4 mr-2' }),
                'Refresh Config',
              ),
              React.createElement(
                Button,
                { variant: 'secondary', onClick: () => resetKiosk(selectedKiosk.id) },
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                {
                  className:
                    'text-xs text-gray-500 mt-4 p-3 bg-blue-50 border border-blue-200 rounded-md',
                },
      ...
      React.createElement(
        ...
        React.createElement(
          Button,
          { variant: 'secondary', onClick: () => setSelectedKiosk(null) },
          'Close',
        ),
      ),
    ),
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Button,
          { variant: 'secondary', onClick: () => setShowScheduleModal(false) },
          'Close',
        ),
      ),
    ),
