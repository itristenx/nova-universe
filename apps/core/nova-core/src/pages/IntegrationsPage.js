...
export const IntegrationsPage = () => {
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  'li',
                  null,
                  'Navigate to "Apps" \u2192 "App Directory" \u2192 "Manage"',
                ),
  ...
  return React.createElement(
        ...
        : integrations.length === 0
          ...
          : React.createElement(
              ...
              integrations.map((integration) =>
                React.createElement(
                  'div',
                  { key: integration.id, className: 'p-6' },
                  React.createElement(
                    'div',
                  ...
                  integration.lastError &&
                    React.createElement(
                      ...
                      {
                        className:
                          'mt-4 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md',
                      },
                      React.createElement(
                        'p',
    ...
    React.createElement(
      Modal,
      { isOpen: showCreateModal, onClose: closeModals, title: 'Add Integration', size: 'lg' },
      React.createElement(
        'div',
        { className: 'space-y-4' },
        React.createElement(Input, {
