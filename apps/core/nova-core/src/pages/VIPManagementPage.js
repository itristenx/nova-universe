...
export const VIPManagementPage = () => {
    ...
    return (React.createElement(Card, null,
        ...
        React.createElement("table", { className: "min-w-full divide-y divide-gray-200" },
            ...
            React.createElement("tbody", { className: "bg-white divide-y divide-gray-200" }, users.map(u => (React.createElement("tr", { key: u.id },
                React.createElement("td", { className: "px-4 py-2" }, u.name),
                React.createElement("td", { className: "px-4 py-2" },
                    React.createElement("input", { type: "checkbox", checked: !!u.is_vip, onChange: e => updateVip(u, e.target.checked, u.vip_level || 'priority') })),
                React.createElement("td", { className: "px-4 py-2" },
                    React.createElement(Select, { value: u.vip_level || 'priority', onChange: val => updateVip(u, !!u.is_vip, val) },
