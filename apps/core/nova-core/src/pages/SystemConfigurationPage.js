    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          {
            color: 'success',
            startContent: React.createElement(WrenchScrewdriverIcon, { className: 'w-4 h-4' }),
            onPress: saveConfig,
            isLoading: saving,
          },
          'Save Configuration',
              ...
              React.createElement(
                ...
                React.createElement(
                  Select,
                  {
                    ...
                    onSelectionChange: (keys) =>
                      updateConfig('general', 'defaultLanguage', Array.from(keys)[0]),
                  },
                ...
                React.createElement(
                  Select,
                  {
                    ...
                    onSelectionChange: (keys) =>
                      updateConfig('general', 'logLevel', Array.from(keys)[0]),
                  },
