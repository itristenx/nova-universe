        ...
        authStats &&
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'span',
                { className: 'font-semibold text-xl text-green-600' },
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            {
              className:
                'w-full bg-purple-600 text-white py-2 px-4 rounded-md hover:bg-purple-700 transition-colors',
            },
            'Manage Users & Roles',
          ),
          React.createElement(
          ...
          React.createElement(
            ...
            {
              className:
                'w-full bg-green-600 text-white py-2 px-4 rounded-md hover:bg-green-700 transition-colors',
            },
            'SCIM Provisioning',
          ),
          React.createElement(
            ...
            {
              className:
                'w-full bg-orange-600 text-white py-2 px-4 rounded-md hover:bg-orange-700 transition-colors',
            },
          ...
          React.createElement(
            ...
            {
              className:
                'w-full bg-gray-600 text-white py-2 px-4 rounded-md hover:bg-gray-700 transition-colors',
            },
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                'System enhancement deployed successfully',
              ),
            ),
            React.createElement(
              'span',
