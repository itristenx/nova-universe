  ...
  if (loading) {
    return React.createElement(
      ...
      React.createElement(
        ...
        { className: 'space-y-2' },
        [...Array(5)].map((_, i) =>
          React.createElement('div', { key: i, className: 'h-16 bg-gray-200 rounded' }),
        ),
      ),
    );
  }
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    {
                      className:
                        'h-10 w-10 rounded-full bg-indigo-500 flex items-center justify-center',
                    },
                    React.createElement(
                      'span',
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  user.disabled
                    ? React.createElement(UserPlusIcon, { className: 'h-4 w-4' })
                    : React.createElement(UserMinusIcon, { className: 'h-4 w-4' }),
                ),
                React.createElement(
                  'button',
                  {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('input', {
            ...
            className:
              'w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent',
      ...
      React.createElement(
        ...
        React.createElement(
          'select',
          {
            ...
            className:
              'w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent',
      ...
      React.createElement(
        ...
        React.createElement(
          'button',
          {
            ...
            className:
              'ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed',
          },
          'Next',
        ),
      ),
...
export const UserManagementPage = () => {
  ...
  return React.createElement(
    ...
    React.createElement(
      Modal,
      { isOpen: showCreateModal, onClose: closeModals, title: 'Create User' },
      React.createElement(
        'div',
        { className: 'space-y-4' },
        React.createElement(Input, {
      ...
      React.createElement(
        ...
        React.createElement(
          Button,
          { variant: 'primary', onClick: submitCreateUser, disabled: !isFormValid(formData, true) },
          'Create',
        ),
      ),
    ),
